...
let burger = { name: "Burger", price: 18, category: "Lunch" };
...
const apples = createMenuItem('Apples', 5, 'Breakfast');
const milkshake = createMenuItem('Milkshake', 5, 'Dessert');
...
reviews.push({ name: "Monique", rating: 4.5, feedback: "Friendly staff, and amazing food!" });
